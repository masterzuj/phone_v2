...
<div id="menu">
	...
	<div style="position: absolute; left: 200px; font-size: 30px; color: white;"><a onclick="window.parent.location.href = 'just_phone.php';">⌂</a></div>
	<div style="position: absolute; left: 250px; color: black; font-size: 20px; margin-top: 10px; color: white;">ⓩⓤⓚⓤⓝⓕⓣ</div>
